...
const images = {
				...
				const frontmatter = {"layout":"../../layouts/MarkDownPostLayout.astro","title":"Astro Blog Post 2","pubDate":"09.01.2023","description":"This is the first Astro Blog post by Rich","author":"Rich Fly","image":{"url":"https://docs.astro.build/default-og-image.png","alt":"The word “astro” against an illustration of planets and stars."},"tags":["astro","blogging","learning in public"]};
