import { c as createAstro, a as createComponent, r as renderTemplate, d as renderComponent, g as renderTransition, m as maybeRenderHead, b as addAttribute, f as renderSlot, s as spreadAttributes, u as unescapeHTML } from '../astro.3487e211.mjs';
...
const $$MarkdownPostLayout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "pageTitle": frontmatter.title, "data-astro-transition-scope": renderTransition($$result, "khdj2oxq", "slide", "blogpost") }, { "default": ($$result2) => renderTemplate`${maybeRenderHead()}<p>Published on: ${frontmatter.pubDate.slice(0, 10)}</p><p>Written by: ${frontmatter.author}</p><p><em>${frontmatter.description}</em></p><img${addAttribute(frontmatter.image.url, "src")} width="300"${addAttribute(frontmatter.image.alt, "alt")}>${renderSlot($$result2, $$slots["default"])}<div class="tags">${frontmatter.tags.map((tag) => renderTemplate`<p class="tag"><a${addAttribute(`/tags/${tag}`, "href")}>${tag}</a></p>`)}</div>` })}`;
}, "C:/Users/Richj/richs-portfolio/src/layouts/MarkdownPostLayout.astro", "self");
...
const images = {
				...
				const frontmatter = {"layout":"/src/layouts/MarkdownPostLayout.astro","title":"Astro Blog Post","pubDate":"09.01.2023","description":"This is the first Astro Blog post by Rich","author":"Rich Fly","image":{"url":"https://docs.astro.build/default-og-image.png","alt":"The word “astro” against an illustration of planets and stars."},"tags":["astro","blogging","learning in public"]};
				const file = "C:/Users/Richj/richs-portfolio/src/pages/posts/post-1.md";
