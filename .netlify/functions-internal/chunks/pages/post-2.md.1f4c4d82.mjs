...
import { $ as $$MarkdownPostLayout } from './post-1.md.27059911.mjs';
...
const images = {
				...
				const frontmatter = {"layout":"/src/layouts/MarkdownPostLayout.astro","title":"Astro Blog Post 2","pubDate":"09.01.2023","description":"This is the first Astro Blog post by Rich","author":"Rich Fly","image":{"url":"https://docs.astro.build/default-og-image.png","alt":"The word “astro” against an illustration of planets and stars."},"tags":["astro","blogging","learning in public"]};
				const file = "C:/Users/Richj/richs-portfolio/src/pages/posts/post-2.md";
